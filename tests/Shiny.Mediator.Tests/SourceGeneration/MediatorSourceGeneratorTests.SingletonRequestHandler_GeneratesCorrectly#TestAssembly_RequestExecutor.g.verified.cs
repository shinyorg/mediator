...
internal class TestAssemblyRequestExecutor : global::Shiny.Mediator.Infrastructure.RequestExecutor
{
    ...
    {
        if (request is global::MyNamespace.Handlers.MyRequest p0)
        {
            object result = await this.Execute<global::MyNamespace.Handlers.MyRequest, global::MyNamespace.Handlers.MyResponse>(p0, context, cancellationToken);
    ...
    {
        if (request is global::MyNamespace.Handlers.MyRequest)
            return true;
