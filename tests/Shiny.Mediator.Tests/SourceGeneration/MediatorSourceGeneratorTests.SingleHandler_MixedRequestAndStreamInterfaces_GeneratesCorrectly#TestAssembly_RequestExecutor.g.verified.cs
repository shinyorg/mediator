...
internal class TestAssemblyRequestExecutor : global::Shiny.Mediator.Infrastructure.RequestExecutor
{
    ...
    {
        if (request is global::MyApp.MixedHandlers.GetDataRequest p0)
        {
            object result = await this.Execute<global::MyApp.MixedHandlers.GetDataRequest, global::MyApp.MixedHandlers.DataResponse>(p0, context, cancellationToken);
    ...
    {
        if (request is global::MyApp.MixedHandlers.GetDataRequest)
            return true;
