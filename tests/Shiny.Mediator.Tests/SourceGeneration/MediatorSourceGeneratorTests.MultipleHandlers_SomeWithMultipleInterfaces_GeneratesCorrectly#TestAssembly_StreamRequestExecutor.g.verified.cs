...
internal class TestAssemblyStreamRequestExecutor : global::Shiny.Mediator.Infrastructure.StreamRequestExecutor
{
    ...
    {
        if (request is global::MyApp.Combined.StreamRequest1 p0)
        {
            var handle = this.Execute<global::MyApp.Combined.StreamRequest1, string>(context, p0, cancellationToken);
    ...
    {
        if (request is global::MyApp.Combined.StreamRequest1)
            return true;
