...
internal class TestAssemblyRequestExecutor : global::Shiny.Mediator.Infrastructure.RequestExecutor
{
    ...
    {
        if (request is global::MyApp.Request1 p0)
        {
            object result = await this.Execute<global::MyApp.Request1, global::MyApp.Response1>(p0, context, cancellationToken);
            return (TResult)result;
        }

        if (request is global::MyApp.Request2 p1)
        {
            object result = await this.Execute<global::MyApp.Request2, global::MyApp.Response2>(p1, context, cancellationToken);
            return (TResult)result;
        }
    ...
    {
        if (request is global::MyApp.Request1)
            return true;

        if (request is global::MyApp.Request2)
            return true;
