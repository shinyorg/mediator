...
internal class TestAssemblyRequestExecutor : global::Shiny.Mediator.Infrastructure.RequestExecutor
{
    ...
    {
        if (request is global::MyApp.GetListRequest p0)
        {
            object result = await this.Execute<global::MyApp.GetListRequest, global::System.Collections.Generic.List<string>>(p0, context, cancellationToken);
    ...
    {
        if (request is global::MyApp.GetListRequest)
            return true;
