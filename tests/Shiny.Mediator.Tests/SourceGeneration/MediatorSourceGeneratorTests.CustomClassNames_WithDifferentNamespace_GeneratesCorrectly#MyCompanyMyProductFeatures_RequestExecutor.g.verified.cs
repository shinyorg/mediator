//HintName: MyCompanyMyProductFeatures_RequestExecutor.g.cs
// <auto-generated>
...
internal class CustomRequestExec : global::Shiny.Mediator.Infrastructure.RequestExecutor
{
    ...
    {
        if (request is global::MyCompany.MyProduct.Features.MyRequest p0)
        {
            object result = await this.Execute<global::MyCompany.MyProduct.Features.MyRequest, global::MyCompany.MyProduct.Features.MyResponse>(p0, context, cancellationToken);
    ...
    {
        if (request is global::MyCompany.MyProduct.Features.MyRequest)
            return true;
