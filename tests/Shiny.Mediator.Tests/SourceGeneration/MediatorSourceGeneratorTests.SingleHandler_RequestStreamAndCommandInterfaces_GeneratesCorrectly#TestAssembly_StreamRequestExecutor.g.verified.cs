...
internal class TestAssemblyStreamRequestExecutor : global::Shiny.Mediator.Infrastructure.StreamRequestExecutor
{
    ...
    {
        if (request is global::MyApp.ComplexHandlers.StreamUsersRequest p0)
        {
            var handle = this.Execute<global::MyApp.ComplexHandlers.StreamUsersRequest, global::MyApp.ComplexHandlers.UserDto>(context, p0, cancellationToken);
    ...
    {
        if (request is global::MyApp.ComplexHandlers.StreamUsersRequest)
            return true;
