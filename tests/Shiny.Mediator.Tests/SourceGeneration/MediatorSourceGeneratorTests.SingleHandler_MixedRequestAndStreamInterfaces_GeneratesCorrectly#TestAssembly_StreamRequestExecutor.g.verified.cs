...
internal class TestAssemblyStreamRequestExecutor : global::Shiny.Mediator.Infrastructure.StreamRequestExecutor
{
    ...
    {
        if (request is global::MyApp.MixedHandlers.StreamDataRequest p0)
        {
            var handle = this.Execute<global::MyApp.MixedHandlers.StreamDataRequest, global::MyApp.MixedHandlers.DataItem>(context, p0, cancellationToken);
    ...
    {
        if (request is global::MyApp.MixedHandlers.StreamDataRequest)
            return true;
