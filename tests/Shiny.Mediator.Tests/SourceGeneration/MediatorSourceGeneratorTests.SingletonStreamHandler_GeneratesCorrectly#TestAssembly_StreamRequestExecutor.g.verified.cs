...
global::Shiny.Mediator.IStreamRequest<TResult> request,
    ...
    {
      if (request is global::MyApp.Streams.TickerRequest p0)
        {
   var handle = this.Execute<global::MyApp.Streams.TickerRequest, string>(context, p0, cancellationToken);
    ...
    {
        if (request is global::MyApp.Streams.TickerRequest)
        return true;
