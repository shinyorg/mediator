//HintName: MainApp_StreamRequestExecutor.g.cs
// <auto-generated>
...
internal class MainAppStreamRequestExecutor : global::Shiny.Mediator.Infrastructure.StreamRequestExecutor
{
...
global::Shiny.Mediator.IStreamRequest<TResult> request,
    ...
    {
      if (request is global::Project2.Features.Project2StreamRequest p0)
        {
   var handle = this.Execute<global::Project2.Features.Project2StreamRequest, string>(context, p0, cancellationToken);
    ...
    {
        if (request is global::Project2.Features.Project2StreamRequest)
        return true;
