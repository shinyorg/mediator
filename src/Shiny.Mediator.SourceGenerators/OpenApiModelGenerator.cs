...
public class OpenApiModelGenerator
{
    ...
    public OpenApiModelGenerator(MediatorHttpItemConfig config, SourceProductionContext context)
    {
        this.config = config;
    ...
    private void GenerateEnum(string enumName, OpenApiSchema schema)
    {
        ...
        {
            // TODO: Call JsonConverterSourceGenerator if needed
        }
    }

    private void GenerateClass(string className, OpenApiSchema schema)
    {
        var sb = new StringBuilder();
        sb.AppendLine("// <auto-generated>");
        sb.AppendLine("// Code generated by Shiny Mediator OpenAPI Source Generator.");
        ...
        {
            var baseSchema = schema.AllOf[0] as OpenApiSchema;
            if (baseSchema != null)
            {
    ...
    private static string GetStringType(OpenApiSchema schema)
    {
