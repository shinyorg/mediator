...
public class NewMediatorSourceGenerator : IIncrementalGenerator
{
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        // Register post initialization to generate the assembly attribute
        context.RegisterPostInitializationOutput(ctx => ctx.AddSource(
            "MediatorGenerationAttribute.g.cs",
            SourceText.From(
                """
                // <auto-generated>
                ...
                internal sealed class MediatorGenerationAttribute : global::System.Attribute 
                {}
   ...
   .Combine(context.AnalyzerConfigOptionsProvider)
            .Select((pair, _) =>
     {
         ...
         if (options.GlobalOptions.TryGetValue("build_property.MediatorGenerator", out var msbuildValue)
   ...
   .Select((provider, _) => provider.GlobalOptions.TryGetValue("build_property.ShinyStreamRequestExecutorClassName", out var value) && !string.IsNullOrWhiteSpace(value) ? value : null);
            ...
            .Select((pair, _) =>
      {
          ...
          if (!enabled)
              return (Handlers: ImmutableArray<HandlerInfo>.Empty, Middleware: ImmutableArray<MiddlewareInfo>.Empty);
   ...
   .Combine(rootNamespace)
    ...
    static void CollectHandlersAndMiddleware(INamedTypeSymbol classSymbol, List<HandlerInfo> handlers, List<MiddlewareInfo> middleware)
    {
